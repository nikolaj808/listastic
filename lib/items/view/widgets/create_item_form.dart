...
class _CreateItemFormState extends State<CreateItemForm> {
  ...
  Future<void> _createItem(BuildContext context) async {
    final currentFormState = CreateItemForm._formKey.currentState;
    ...
    return context.read<ItemsCubit>().createItem(newItem);
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                BlocBuilder<ItemsCubit, ItemsCubitState>(
                  builder: (context, state) {
                    return FloatingActionButton(
                      elevation: 0,
                      onPressed: () => _createItem(context),
                      child: state is ItemCreating
